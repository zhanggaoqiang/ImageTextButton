...
- (void)alignmentValueChanged {
    ...
    CGFloat imgOffsetX=0;    // horizontal offset of image
    CGFloat imgOffsetY=0;    // vertical offset of image
    CGFloat titleOffsetX=0;  // horizontal offset of title
    CGFloat titleOffsetY=0;  // vertical offset of title
